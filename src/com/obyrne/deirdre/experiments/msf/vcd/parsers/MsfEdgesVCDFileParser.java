...
public class MsfEdgesVCDFileParser extends AbstractMsfTimecodeVCDFileParser {
	...
	public MsfEdgesVCDFileParser(MsfTimecodeGenerator timecode) throws IOException {
		super(timecode);
