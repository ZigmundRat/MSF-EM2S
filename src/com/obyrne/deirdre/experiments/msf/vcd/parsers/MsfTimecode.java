...
public class MsfTimecode extends AbstractMsfTimecodeVCDFileParser implements MsfMillisecondSignalLevelProcessor {
	...
	public MsfTimecode(MsfTimecodeGenerator timecode) throws IOException {
		super(timecode);
