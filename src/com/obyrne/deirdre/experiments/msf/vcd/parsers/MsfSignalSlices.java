...
public class MsfSignalSlices extends AbstractMsfTimecodeVCDFileParser implements MsfMillisecondSignalLevelProcessor {
	...
	public MsfSignalSlices(String fileName, MsfSignalMillisecondSignalSlice[] slices, MsfTimecodeGenerator timecode) throws IOException {
		super(timecode);
		mySlices = slices;
